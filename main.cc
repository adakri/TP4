...
int main()
{
	...
	OdeSystem<double>* sys(0); ///ou FirstExampleOdeSystem
	...
	cout << "3) AdBashforthScheme3" << endl;
	...
	switch(userChoiceSys)
	{
		case 1:
			...
			results += "_Euler_exp.txt";
			break;
		case 2:
			time_scheme = new RungeKuttaScheme3();
			results += "_RungeKuttaScheme3.txt";
			break;
		case 3:
			time_scheme = new AdBashforthScheme3();
			results += "_AdBashforthScheme3.txt";
			break;
		default:
			cout << "Ce choix n’est pas possible ! Veuillez recommencer !" << endl;
			exit(0);
