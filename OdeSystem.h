...
class OdeSystem
{
  ...
  protected:
    // Votre fonction f
    Eigen::Matrix<T, Eigen::Dynamic, 1> _f;
    std::ofstream _file_out;
  ...
  public:
    ...
    virtual void SaveSolution(const double t, const Eigen::Matrix<T, Eigen::Dynamic, 1> & sol);
    // Pour récupérer _f
    const Eigen::VectorXd &  GetF()  const;
    // Pour construire _f en fonction de votre système
    virtual void BuildF(const double t, const Eigen::Matrix<T, Eigen::Dynamic, 1> & sol)=0;
};


//-------------------------------------------------------------
// Classe fille publique d’OdeSystem
class FirstExampleOdeSystem : public OdeSystem<double>
{
  public:
...
class SecondExampleOdeSystem : public OdeSystem<double>
{
  public:
...
class ThirdExampleOdeSystem : public OdeSystem<double>
{
  public:
    void BuildF(const double t, const Eigen::VectorXd & sol);
...
class LotkaVolterraOdeSystem : public OdeSystem<double>
{
private:
  double _a,_b,_c,_d;
public:
...
//pendulum system
class PendulumOdeSystem : public OdeSystem<double>
{
  private:
    double _m,_k,_l;
  public:
